  ...
  return (
    <div className="content-card fade-in">
      ...
      <div style={{ background: '#f8fafc', padding: '2rem', borderRadius: '16px', border: '1px solid #e2e8f0', marginBottom: '2.5rem' }}>
        <h3 style={{ color: '#2563eb', marginBottom: '1rem', display: 'flex', alignItems: 'center', gap: '10px' }}>
      ...
      <h3 style={{ color: '#1e293b', marginBottom: '1.5rem', borderBottom: '2px solid #e2e8f0', paddingBottom: '10px' }}>
      ...
      <div style={{ background: '#f0fdf4', padding: '2rem', borderRadius: '16px', border: '1px solid #bbf7d0' }}>
        <h3 style={{ color: '#166534', marginBottom: '1rem', display: 'flex', alignItems: 'center', gap: '10px' }}>
